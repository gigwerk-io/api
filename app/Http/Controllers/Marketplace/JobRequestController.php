...
class JobRequestController extends Controller
{
     ...
     * @BodyParam(name"intensity_id", type="unsignedBigInteger", status="optional", description="How hard the job is.", example="easy medium or hard")
     * @BodyParam(name"price", type="double", status="optional", description="How much it costs", example="$68.99")
